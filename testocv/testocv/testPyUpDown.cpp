...
//      描述：全局变量声明  
//-----------------------------------------------------------------------------------------------  
static Mat g_srcImage, g_dstImage, g_tmpImage;
...
static void ShowHelpText()
{
	...
	printf("\n\n\t按键操作说明: \n\n"
		"\t\t键盘按键【ESC】或者【Q】- 退出程序\n"
		"\t\t键盘按键【1】- 进行基于【resize】函数的图片放大\n"
		"\t\t键盘按键【2】- 进行基于【resize】函数的图片缩小\n"
		"\t\t键盘按键【3】- 进行基于【pyrUp】函数的图片放大\n"
		"\t\t键盘按键【4】- 进行基于【pyrDown】函数的图片缩小\n"
	);
}
...
int testPyUpDown()
{
	...
	//载入原图  
	g_srcImage = imread("girl.jpg");//工程目录下需要有一张名为1.jpg的测试图像，且其尺寸需被2的N次方整除，N为可以缩放的次数  
